                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="departmentId" class="form-select">
                                ...
                                @foreach ($department as $item)
                                    <option {{ old('departmentId', $data->department->id) == $item->id ? 'selected' : '' }}
                        ...
                        <div class="col-12 mb-3">
                            ...
                            <input type="url" name="linkedin" placeholder="Linkedin Profile Page URL"
                                class="form-control" value="{{ old('linkedin', $data->linkedin) }}">
                        </div>

                        <div class="col-12 mb-3">
                            <label>Instagram Profile Page</label>
                            <input type="url" name="instagram" placeholder="Instagram Profile Page URL"
                                class="form-control" value="{{ old('instagram,$data->instagram') }}">
                        </div>
