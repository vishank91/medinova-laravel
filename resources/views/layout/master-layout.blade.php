            ...
            <div class="row">
                <div class="col-md-8 text-center text-lg-start mb-2 mb-lg-0">
                    <div class="d-inline-flex align-items-center">
                        <a class="text-decoration-none text-body pe-3" href="{{ config('app.siteMap1') }}"
                            target="_blank"><i class="bi bi-geo-alt me-2"></i>{{ config('app.siteAddress') }}</a>
                        <a class="text-decoration-none text-body pe-3" href="mailto:{{ config('app.siteEmail') }}"
                            target="_blank"><i class="bi bi-envelope me-2"></i>{{ config('app.siteEmail') }}</a>
                        <a class="text-decoration-none text-body pe-3" href="tel:{{ config('app.sitePhone') }}"
                            target="_blank"><i class="bi bi-telephone me-2"></i>{{ config('app.sitePhone') }}</a>
                        <span class="text-body me-2">|</span>
                        <a class="text-decoration-none text-body pe-3"
                            href="https:://wa.me/{{ config('app.siteWhatsapp') }}" target="_blank"><i
                                class="bi bi-whatsapp me-2"></i>{{ config('app.siteWhatsapp') }}</a>
                    </div>
                </div>
                <div class="col-md-4 text-center text-lg-end">
                    <div class="d-inline-flex align-items-center">
                        <a class="text-body px-2" href="{{config('app.facebook')}}">
                            <i class="fab fa-facebook-f"></i>
                        </a>
                        <a class="text-body px-2" href="{{config('app.twitter')}}">
                            <i class="fab fa-twitter"></i>
                        </a>
                        <a class="text-body px-2" href="{{config('app.linkedin')}}">
                            <i class="fab fa-linkedin-in"></i>
                        </a>
                        <a class="text-body px-2" href="{{config('app.instagram')}}">
                            <i class="fab fa-instagram"></i>
                        </a>
                        <a class="text-body ps-2" href="{{config('app.youtube')}}">
